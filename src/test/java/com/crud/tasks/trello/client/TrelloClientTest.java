...
public class TrelloClientTest {
    ...
    public void init(){
        ...
        Mockito.when(trelloConfig.getTrelloUsername()).thenReturn("greedfire");
    }
    ...
    public void shouldFetchTrelloBoards() throws URISyntaxException {
        ...
        URI uri = new URI("http://test.com/members/greedfire/boards?key=test&token=test&fields=name,id&lists=all");
    ...
    public void shouldCreateCard() throws URISyntaxException{
        ...
        CreatedTrelloCard createdTrelloCard = new CreatedTrelloCard(
                ...
                "Test task",
                "http://test.com",
                new BadgesDto(1, new AttachmentsByType(new Trello(1,1)))
        );
